...
riborf_ORF_sequence <- read_tsv(
    "/home/chengennong/Ribo_benchmark/unique_mapping/Human/preprocessing/riborf_chrN/index/Human/candidateORF.seq",
    col_names = F,
    col_select = c(
        "ORF_ID" = "X1",
        "ORF_sequence" = "X2"
...
riborf_index <- read_tsv(
    "/home/chengennong/Ribo_benchmark/unique_mapping/Human/preprocessing/riborf_chrN/index/Human/candidateORF.genepred.txt",
    col_names = F,
    col_select = c(
        "ORF_ID" = "X1",
        "ORF_gstart" = "X6",
