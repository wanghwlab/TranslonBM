...
ribotricer_index <- read_tsv(
    "/home/chengennong/Ribo_benchmark/unique_mapping/Human/preprocessing/ribotricer_chrN/index/Human.fasta",
    col_names = T
)

ribotricer_ORF_coordinate <- read_tsv(
    "/home/chengennong/Ribo_benchmark/unique_mapping/Human/preprocessing/ribotricer_chrN/index/Human_candidate_orfs.tsv",
    col_names = T
)
## need improvement
