...
ORFRATER_ENV = "orfrater_env"

#################################
# 2. 路径定义
#################################
OUT_DIR = "/home/tangyuewen/ORF_benchmark/rerun_2025.9/ORFdetect_untrim/orfrater"
...
rule rate_regression_output:
  ...
  params:
    ...
    regression_h5 = './Ribo/regression.h5'
  shell:
    r"""
...
rule quantify_orfs:
  input:
    ...
    ratedorfs_bed = 'orfrater_chrN/orf_pred_default/{sample}_{mpsf}/ratedorfs.bed'
  output:
    quant_h5 = 'orfrater_chrN/orf_pred_default/{sample}_{mpsf}/Ribo/quant.h5',
  ...
  benchmark: 'time_benchmarks/orfrater_chrN/orf_pred_default_run2/{sample}_{mpsf}_quantify_orfs.txt'
  shell:
    r"""
