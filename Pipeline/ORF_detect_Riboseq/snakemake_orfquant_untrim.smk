...
# 2. 路径定义
#################################
OUT_DIR = "/home/tangyuewen/ORF_benchmark/rerun_2025.9/ORFdetect_rerun_untrim/orfquant"
...
GENOME_FILE = "/home/tangyuewen/ORF_benchmark/Ref/genome_file"
...
rule adjust_mapq_tophat2:
  ...
  shell:
        ...
        ~/miniconda3/bin/bedtools bamtobed -i {input.raw_bam} \
            -bed12 -split -cigar > {output.bed}

        ~/miniconda3/bin/bedtools bedtobam -i {output.bed} \
