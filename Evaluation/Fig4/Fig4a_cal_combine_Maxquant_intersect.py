...
BASE_OUTPUT_DIR = "/home/tangyuewen/ORF_benchmark/final_ORFs_2026.1/plots_combine/Maxquant_score_intersect_untrim/"
        ...
        for level in ['peptide', 'protein']:
            ...
            for aligner, tool_predictions in predictions_data.items():
                ...
                for tool_a, tool_b in itertools.combinations(tools, 2):
                    ...
                    orfs_combined = orfs_a.intersection(orfs_b)
                    ...
                    intersection_count = len(orfs_combined)
                    real_union_count = len(orfs_a.union(orfs_b)) 
                    
                    jaccard_index = intersection_count / real_union_count if real_union_count > 0 else 0
