...
# Colors: Unique (green), Overlap (purple), Common (blue)
#colors = ['#90C987', '#C5A6CF', '#8DCFFF']
colors = ['#89bbe9', '#d2c2d7', '#b2cfa5']

print(f"Plotting and saving to {output_pdf} ...")
...
with PdfPages(output_pdf) as pdf:
    ...
    for ax, aligner in zip(axes, aligners):
        ...
        for i in range(len(x)):
            ...
            # --- Text labels (retain two decimal places) ---
            # 1. Unique label
...
print("Script completed. Check the generated PDF file.")
