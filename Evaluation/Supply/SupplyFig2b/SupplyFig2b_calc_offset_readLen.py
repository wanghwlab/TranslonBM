...
def process_data(file_path):
    ...
    # --- Task 1: group by sample and ORFtools ---
    ...
    print(f"File 1 generated (grouped by sample and tool): {output_file_1}")

    # --- Task 2: group by sample only ---
    ...
    print(f"File 2 generated (grouped by sample only): {output_file_2}")
