# ==============================================================================
# RiboSim.R — A Flexible Ribo-seq Data Simulator
# Version : 1.0.0
...
# Digestion length framework inspired by simRiboSeq's d5_bias / d3_bias
# (Mok et al. 2023, doi:10.1101/2023.02.21.529452); values here are independently
# fitted by nloptr from experimental data. Geometry re-anchored from the A-site
# to the P-site codon: d5_here = d5_choros - 3, d3_here = d3_choros + 3.
...
get_raw_reads <- function(ORF_tstart, ORF_tstop, transcript_seq, RPF_count_info, mutation = NULL) {
    ...
    RPF_count_info |>
        mutate(
            # Footprint geometry inspired by simRiboSeq::digest_transcript()
            # (Mok et al. 2023, doi:10.1101/2023.02.21.529452):
            #   read = d5 flank + 3-nt codon + d3 flank
            # simRiboSeq anchors at the A-site codon; here re-anchored to the
            # P-site codon: d5_here = d5_choros - 3, d3_here = d3_choros + 3
